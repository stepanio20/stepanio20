...
MEALS: list[dict[str, Any]] = [
    ...
    {"name": "Poke bowl (salmon, rice, edamame)", "slot": "main",
     "kcal": 610, "p": 38, "c": 66, "f": 20, "tags": ["fish"], "rung": "order"},
    {"name": "Falafel + hummus bowl, salad", "slot": "main",
     "kcal": 560, "p": 22, "c": 72, "f": 22, "tags": ["vegan", "vegetarian", "gluten"], "rung": "order"},
    {"name": "Grilled prawn + veg paella (small)", "slot": "main",
     "kcal": 590, "p": 34, "c": 70, "f": 16, "tags": ["fish"], "rung": "order"},
    # ---- snacks -------------------------------------------------------------
