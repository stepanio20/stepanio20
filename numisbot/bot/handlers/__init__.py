from . import (admin, auctions, channel, estimate, fallback, market, nav,
               portfolio, seller, start, subscribe, watchlist)
...
ROUTERS = [subscribe.router, nav.router, start.router, watchlist.router,
           ...
           seller.router, admin.router, channel.router, fallback.router]
